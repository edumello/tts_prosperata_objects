...
<Defaults>
    ...
    <Button class="rowButton" fontSize="23" fontStyle="Bold"
            ...
            colors="#171613EE|#2B261D|#0F0F0DEE|#0F0F0DCC"
            outline="#5B4A29" outlineSize="2 2" padding="24 125 5 5" />
    ...
    <Button class="miniButton" fontSize="26" fontStyle="Bold"
            ...
            colors="#28251F|#474033|#181612|#16140FCC"
            outline="#8B7440" outlineSize="2 2" padding="2 2 2 2" />
