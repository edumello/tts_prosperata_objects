...
<Defaults>
    ...
    <Panel class="line" color="#8F7425" raycastTarget="false" />
    <Panel class="section" color="#0D0E0FF4" raycastTarget="false" />
    <Panel class="statePill" color="#292C30" outline="#555A60"
           outlineSize="2 2" raycastTarget="false" />
    <Panel class="previewCard" color="#0B2518F6" outline="#1E6D43"
           outlineSize="2 2" raycastTarget="false" />
    ...
    <Button class="rowButton" fontSize="23" fontStyle="Bold"
            textColor="#E0E1E3" textAlignment="MiddleLeft"
            resizeTextForBestFit="true" resizeTextMinSize="16"
            resizeTextMaxSize="24"
            colors="#181A1C|#26292C|#111315|#111315CC"
            outline="#34383D" outlineSize="2 2" padding="24 125 5 5" />
    <Button class="modeButton" fontSize="20" fontStyle="Bold"
            ...
            colors="#201C0D|#393015|#151208|#121008CC"
            outline="#8F7425" outlineSize="2 2" padding="22 12 5 5" />
    <Button class="miniButton" fontSize="26" fontStyle="Bold"
            ...
            colors="#2A2D31|#44484D|#191B1E|#17191BCC"
            outline="#60656B" outlineSize="2 2" padding="2 2 2 2" />

    <Button class="blueAction" fontSize="31" fontStyle="Bold"
            textColor="#8BB9DF" textAlignment="MiddleCenter"
            resizeTextForBestFit="true" resizeTextMinSize="18"
            resizeTextMaxSize="33"
            colors="#163B5E|#245882|#0F2942|#0C2136CC"
            outline="#3E79A4" outlineSize="3 3" padding="16 16 12 12" />
    <Button class="orangeAction" fontSize="31" fontStyle="Bold"
            textColor="#D8A34F" textAlignment="MiddleCenter"
            resizeTextForBestFit="true" resizeTextMinSize="18"
            resizeTextMaxSize="33"
            colors="#4D2705|#72410D|#331A04|#2C1603CC"
            outline="#986018" outlineSize="3 3" padding="16 16 12 12" />
    <Button class="redAction" fontSize="31" fontStyle="Bold"
            textColor="#D98380" textAlignment="MiddleCenter"
            resizeTextForBestFit="true" resizeTextMinSize="18"
            resizeTextMaxSize="33"
            colors="#521010|#74201F|#350A0A|#2E0909CC"
            outline="#8B302E" outlineSize="3 3" padding="16 16 12 12" />
    <Button class="clearAction" fontSize="29" fontStyle="Bold"
            textColor="#AAA8BF" textAlignment="MiddleCenter"
            resizeTextForBestFit="true" resizeTextMinSize="17"
            resizeTextMaxSize="31"
            colors="#171723|#29293A|#101018|#0E0E16CC"
            outline="#47475E" outlineSize="3 3" padding="16 16 12 12" />

    <InputField class="nameInput" fontSize="21" fontStyle="Bold"
                textColor="#C8C9CC" color="#1A1C1E"
                colors="#1A1C1E|#292C30|#111315|#101214CC"
...
<Panel id="edwardConsole" width="1792" height="1024" rectAlignment="MiddleCenter"
       ...
       color="#08090AF8" raycastTarget="false">

    <!-- Cabecalho -->
    <Text text="EDWARD" width="520" height="84"
          rectAlignment="UpperLeft" offsetXY="68 -34"
          alignment="MiddleLeft" color="#E4C75E" fontSize="52"
          fontStyle="Bold" />
    <Text text="ESPADA DE EXECUÇÃO" width="720" height="64"
          rectAlignment="UpperLeft" offsetXY="1000 -45"
          alignment="MiddleRight" color="#B79B3D" fontSize="27"
          fontStyle="BoldAndItalic" />
    <Panel class="line" width="1732" height="2"
           rectAlignment="UpperLeft" offsetXY="30 -132" />

    <!-- Divisores e titulos das tres colunas -->
    <Panel class="line" width="2" height="548"
           rectAlignment="UpperLeft" offsetXY="610 -150" color="#40391F" />
    <Panel class="line" width="2" height="548"
           rectAlignment="UpperLeft" offsetXY="1160 -150" color="#40391F" />
    <Text text="A T A Q U E S" width="520" height="38"
          rectAlignment="UpperLeft" offsetXY="45 -150"
          alignment="MiddleLeft" color="#C3A743" fontSize="18" />
    <Text text="M O D .  E X T R A S" width="500" height="38"
          rectAlignment="UpperLeft" offsetXY="635 -150"
          alignment="MiddleLeft" color="#C3A743" fontSize="18" />
    <Text text="P R É V I A" width="250" height="38"
          rectAlignment="UpperLeft" offsetXY="1185 -150"
          alignment="MiddleLeft" color="#C3A743" fontSize="18" />
    <Button id="update" class="headerButton" text="ATUALIZAR"
            onClick="uiDispatch" width="180" height="40"
            rectAlignment="UpperLeft" offsetXY="1555 -150" />

    <!-- Condicoes. Cada linha inteira e um botao; o pill e apenas indicador. -->
    <Button id="toggle_preparada" class="rowButton" text="PREPARADA"
            onClick="uiDispatch" width="540" height="62"
            rectAlignment="UpperLeft" offsetXY="45 -205" />
    <Panel id="state_preparada_pill" class="statePill" width="96" height="34"
           rectAlignment="UpperLeft" offsetXY="470 -219">
        <Text id="state_preparada" text="OFF" width="96" height="34"
              rectAlignment="MiddleCenter" color="#C8CBD0" fontSize="17"
              raycastTarget="false" />
    </Panel>

    <Button id="toggle_poderoso" class="rowButton" text="PODEROSO"
            onClick="uiDispatch" width="540" height="62"
            rectAlignment="UpperLeft" offsetXY="45 -280" />
    <Panel id="state_poderoso_pill" class="statePill" width="96" height="34"
           rectAlignment="UpperLeft" offsetXY="470 -294">
        <Text id="state_poderoso" text="OFF" width="96" height="34"
              rectAlignment="MiddleCenter" color="#C8CBD0" fontSize="17"
              raycastTarget="false" />
    </Panel>

    <Button id="toggle_pesado" class="rowButton" text="PESADO"
            onClick="uiDispatch" width="540" height="62"
            rectAlignment="UpperLeft" offsetXY="45 -355" />
    <Panel id="state_pesado_pill" class="statePill" width="96" height="34"
           rectAlignment="UpperLeft" offsetXY="470 -369">
        <Text id="state_pesado" text="OFF" width="96" height="34"
              rectAlignment="MiddleCenter" color="#C8CBD0" fontSize="17"
              raycastTarget="false" />
    </Panel>

    <Button id="toggle_golpe_pessoal" class="rowButton" text="G. PESSOAL"
            onClick="uiDispatch" width="540" height="62"
            rectAlignment="UpperLeft" offsetXY="45 -430" />
    <Panel id="state_golpe_pessoal_pill" class="statePill" width="96" height="34"
           rectAlignment="UpperLeft" offsetXY="470 -444">
    ...
    <Button id="especial_mode" class="modeButton" text="ESPECIAL&#10;INATIVO"
            onClick="uiDispatch" width="326" height="78"
            rectAlignment="UpperLeft" offsetXY="45 -505" />
    <Button id="especial_pm_minus" class="miniButton" text="−"
            onClick="uiDispatch" width="44" height="48"
            rectAlignment="UpperLeft" offsetXY="385 -520" />
    <Text id="especial_pm_value" text="1 PM" width="70" height="48"
          rectAlignment="UpperLeft" offsetXY="436 -520"
          color="#E4C75E" fontSize="20" />
    <Button id="especial_pm_plus" class="miniButton" text="+"
            onClick="uiDispatch" width="44" height="48"
            rectAlignment="UpperLeft" offsetXY="513 -520" />

    <!-- Modificadores extras -->
    <Panel class="section" width="500" height="62"
           rectAlignment="UpperLeft" offsetXY="635 -205" />
    <InputField id="mod_name_1" class="nameInput" text="EXTRA 1" onEndEdit="uiEditModName"
                width="280" height="40" rectAlignment="UpperLeft" offsetXY="650 -216" />
    <Button id="mod_1_minus" class="miniButton" text="−" onClick="uiDispatch"
            width="42" height="40" rectAlignment="UpperLeft" offsetXY="945 -216" />
    <Text id="mod_1_value" text="+0" width="54" height="40"
          rectAlignment="UpperLeft" offsetXY="994 -216" color="#E7E8EA" fontSize="20" />
    <Button id="mod_1_plus" class="miniButton" text="+" onClick="uiDispatch"
            width="42" height="40" rectAlignment="UpperLeft" offsetXY="1055 -216" />

    <Panel class="section" width="500" height="62"
           rectAlignment="UpperLeft" offsetXY="635 -280" />
    <InputField id="mod_name_2" class="nameInput" text="EXTRA 2" onEndEdit="uiEditModName"
                width="280" height="40" rectAlignment="UpperLeft" offsetXY="650 -291" />
    <Button id="mod_2_minus" class="miniButton" text="−" onClick="uiDispatch"
            width="42" height="40" rectAlignment="UpperLeft" offsetXY="945 -291" />
    <Text id="mod_2_value" text="+0" width="54" height="40"
          rectAlignment="UpperLeft" offsetXY="994 -291" color="#E7E8EA" fontSize="20" />
    <Button id="mod_2_plus" class="miniButton" text="+" onClick="uiDispatch"
            width="42" height="40" rectAlignment="UpperLeft" offsetXY="1055 -291" />

    <Panel class="section" width="500" height="62"
           rectAlignment="UpperLeft" offsetXY="635 -355" />
    <InputField id="mod_name_3" class="nameInput" text="EXTRA 3" onEndEdit="uiEditModName"
                width="280" height="40" rectAlignment="UpperLeft" offsetXY="650 -366" />
    <Button id="mod_3_minus" class="miniButton" text="−" onClick="uiDispatch"
            width="42" height="40" rectAlignment="UpperLeft" offsetXY="945 -366" />
    <Text id="mod_3_value" text="+0" width="54" height="40"
          rectAlignment="UpperLeft" offsetXY="994 -366" color="#E7E8EA" fontSize="20" />
    <Button id="mod_3_plus" class="miniButton" text="+" onClick="uiDispatch"
            width="42" height="40" rectAlignment="UpperLeft" offsetXY="1055 -366" />

    <Panel class="section" width="500" height="62"
           rectAlignment="UpperLeft" offsetXY="635 -430" />
    <InputField id="mod_name_4" class="nameInput" text="EXTRA 4" onEndEdit="uiEditModName"
                width="280" height="40" rectAlignment="UpperLeft" offsetXY="650 -441" />
    <Button id="mod_4_minus" class="miniButton" text="−" onClick="uiDispatch"
            width="42" height="40" rectAlignment="UpperLeft" offsetXY="945 -441" />
    <Text id="mod_4_value" text="+0" width="54" height="40"
          rectAlignment="UpperLeft" offsetXY="994 -441" color="#E7E8EA" fontSize="20" />
    <Button id="mod_4_plus" class="miniButton" text="+" onClick="uiDispatch"
            width="42" height="40" rectAlignment="UpperLeft" offsetXY="1055 -441" />

    <!-- Previa -->
    <Panel class="previewCard" width="550" height="145"
           rectAlignment="UpperLeft" offsetXY="1185 -205" />
    <Text text="PM GASTO" width="190" height="110"
          rectAlignment="UpperLeft" offsetXY="1210 -222"
          alignment="MiddleLeft" color="#78A78A" fontSize="21" />
    <Text id="preview_pm" text="0 PM" width="260" height="110"
          rectAlignment="UpperLeft" offsetXY="1440 -222"
          alignment="MiddleRight" color="#7FE0A4" fontSize="28" />

    <Panel class="previewCard" width="550" height="145"
           rectAlignment="UpperLeft" offsetXY="1185 -365" />
    <Text text="ATAQUE" width="190" height="110"
          rectAlignment="UpperLeft" offsetXY="1210 -382"
          alignment="MiddleLeft" color="#78A78A" fontSize="21" />
    <Text id="preview_attack" text="0 / 0 / 0" width="300" height="110"
          rectAlignment="UpperLeft" offsetXY="1400 -382"
          alignment="MiddleRight" color="#7FE0A4" fontSize="27" />

    <Panel class="previewCard" width="550" height="145"
           rectAlignment="UpperLeft" offsetXY="1185 -525" />
    <Text text="DANO" width="190" height="110"
          rectAlignment="UpperLeft" offsetXY="1210 -542"
          alignment="MiddleLeft" color="#78A78A" fontSize="21" />
    <Text id="preview_damage" text="0 / 0 / 0" width="300" height="110"
          rectAlignment="UpperLeft" offsetXY="1400 -542"
          alignment="MiddleRight" color="#7FE0A4" fontSize="27" />

    <!-- Acoes -->
    <Panel class="line" width="1732" height="2"
           rectAlignment="UpperLeft" offsetXY="30 -720" color="#40391F" />
    <Button id="roll_attack" class="blueAction" text="ROLAR ATAQUE&#10;d20 + modificadores"
            onClick="uiDispatch" width="410" height="220"
            rectAlignment="UpperLeft" offsetXY="45 -750" />
    <Button id="roll_critical" class="orangeAction" text="CRÍTICO&#10;dano x4 salvo"
            onClick="uiDispatch" width="410" height="220"
            rectAlignment="UpperLeft" offsetXY="469 -750" />
    <Button id="roll_damage" class="redAction" text="ROLAR DANO&#10;aguardando ataque"
            onClick="uiDispatch" width="410" height="220"
            rectAlignment="UpperLeft" offsetXY="893 -750" />
    <Button id="clear_dice" class="clearAction" text="LIMPAR DADOS&#10;somente deste painel"
            onClick="uiDispatch" width="410" height="220"
            rectAlignment="UpperLeft" offsetXY="1317 -750" />
</Panel>
]==]
...
local function atualizarBotoes()
    ...
    local coresTextoBotao = {
        update = "#E4C75E",
        toggle_preparada = "#E0E1E3",
        toggle_poderoso = "#E0E1E3",
        toggle_pesado = "#E0E1E3",
        toggle_golpe_pessoal = "#E0E1E3",
